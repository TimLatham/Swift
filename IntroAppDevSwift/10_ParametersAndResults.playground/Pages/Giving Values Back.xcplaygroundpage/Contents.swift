...
let movie = makeFavorite(categoryOfThing: "movie", favorite: "Inception")
let subject = makeFavorite(categoryOfThing: "subject", favorite: "artificial intelligence")
let band = makeFavorite(categoryOfThing: "band", favorite: "Smashing Pumpkins")
let myName = "Tim"
...
func introduction(name: String, favMovie: String, favBand: String) -> String {
    return "Hello, my name is \(name). \(favMovie). \(favBand)"
}

print(introduction(name: myName, favMovie: movie, favBand: band))
