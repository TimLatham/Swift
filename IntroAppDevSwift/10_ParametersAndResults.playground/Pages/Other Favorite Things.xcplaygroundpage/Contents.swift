...
printFavorite(categoryOfThing: "song", favorite: "Undone")
printFavorite(categoryOfThing: "Dance", favorite: "lambada")
printFavorite(categoryOfThing: "thing to do", favorite: "program")
