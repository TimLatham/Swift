...
let numberImpossible = impossibleBeliefsCount(pigsFlying: 10, frogsBecomingPrinces: 15, multipleLightningStrikes: 17)
print(impossibleThingsPhrase(numberOfImpossibleThings: numberImpossible, meal: "brunch"))
