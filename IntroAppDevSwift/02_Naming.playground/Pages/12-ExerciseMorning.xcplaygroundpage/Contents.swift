...
let totalMorningRoutine = brushTeeth + uploadPhotos + chooseClothes + shower + goJogging
...
let mustDo = brushTeeth + shower + chooseClothes
let niceToDo = uploadPhotos + goJogging
