...
*/
let totalStorageMB = 8 * 1000.0
let existingUsageMB = 3 * 1000.0
let remainingSpaceMB = totalStorageMB - existingUsageMB
let oneMinuteVideo = 150.0
let minutesToFill = remainingSpaceMB / oneMinuteVideo
