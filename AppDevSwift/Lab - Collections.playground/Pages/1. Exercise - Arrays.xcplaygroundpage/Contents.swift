...
registrationList.append("Tim")
registrationList.append("T")
print(registrationList)
registrationList.contains("T")
registrationList.contains("Tim")

print(registrationList.popLast()!)
print(registrationList)
registrationList.popLast()
/*:
 ...
 */
registrationList += ["Tim", "T", "Kyle", "Skyler"]
print(registrationList)
