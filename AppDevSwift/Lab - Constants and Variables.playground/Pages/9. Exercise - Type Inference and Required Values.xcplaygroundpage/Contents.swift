...
var name: String
//print(name)
print("name can't be printed to the console until it is initialized with a value")
/*:
...
print("Have to declare it as a Double or Float type to force it to accept decimals, defaults to Int type if not specifically declared")
