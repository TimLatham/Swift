...
class Fighter: Spaceship {
    ...
    func fire() {
        remainingFirePower > 0 ? remainingFirePower -= 1:print("Your have no more fire power")
    }
}
 ...
 */
// falcon wasn't initialized on this exercise so there's nothing to add.
// if it had been initialized as a Spaceship, it wouldn't have access to the Fighter subclass options
 ...
 */
destroyer.remainingFirePower = 2
destroyer.fire()
