...
progressUpdate(steps: 1500, goal: 10000)
progressUpdate(steps: 6500, goal: 10000)
...
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    let distanceRatio = currentDistance / totalDistance
    let timeRatio = currentTime / goalTime
    print(timeRatio <= distanceRatio ? "Keep it up!":"You've got to push it just a bit harder")
}
pacing(currentDistance: 5, totalDistance: 10, currentTime: 15, goalTime: 30)
pacing(currentDistance: 5, totalDistance: 10, currentTime: 15, goalTime: 20)
pacing(currentDistance: 5, totalDistance: 10, currentTime: 5, goalTime: 30)
